			...
			for word2 in satisfactionPosC1:
				...
				if pos2 != -1:
					for word3 in service_provider:
						...
						if pos3 != -1:
							wordDist = string.count(tweet," ",pos2,pos3);
							if wordDist <= 2:
								#~ if isNeg == []: #Negation does not occur in the tweet --> does not make any sense
								positive_score += 1;
							#~ else:
								#~ proxTri.write("me "+tweet + "\n");		
